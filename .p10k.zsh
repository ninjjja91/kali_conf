# Generated by Powerlevel10k configuration wizard on 2021-10-23 at 16:22 CEST.
...
# 2 lines, disconnected, full frame, darkest-ornaments, compact, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=92
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=92
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=92
